...
import { 
  User, Settings, Heart, CreditCard, MapPin, Bell, HelpCircle, 
  Shield, LogOut, ChevronRight, Edit3, Star, Calendar, Gift 
          ...
          <View style={styles.menuSection}>
            <TouchableOpacity
              ...
              onPress={async () => {
                ...
                router.replace("/(auth)/login"); // điều hướng ngay lập tức
              }}
            >
